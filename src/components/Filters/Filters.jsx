    ...
    <section className="container flex pt-[50px] justify-center ">
      ...
      >
        <div className="flex flex-col justify-center">
          ...
          <select
            className="cursor-pointer text-[18px] leading-[1.11] text-primary-text-color font-medium outline-none h-[48px] w-[224px] rounded-[14px] px-[18px] bg-background-input-color"
            name="brand"
